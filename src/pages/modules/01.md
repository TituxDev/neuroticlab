...
Primero haremos el proceso de **ponderación**, que va a asociar **cada entrada con su respectivo peso** mediante una multiplicación, y combinará los productos de estas operaciones mediante una sencilla suma. A este resultado **se le suma el valor del sesgo**. La operación se vería algo así: **Sesgo + (E1 x P1) + (E2 x P2) + ...**.
...
En los próximos módulos, cuando utilicemos otras funciones de activación, te mostraré cómo reemplazarlas de manera automática dentro de evaluar_neurona().
